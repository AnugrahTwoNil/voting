            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= ($current_page == 'calon.php' || $current_page == 'tambah_calon.php' || $current_page == 'edit_calon.php') ? 'active' : ''; ?>"
                        ...
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M96 96L96 544L544 544L544 96L96 96zM412.5 421.2L320 509.9L227.5 421.2L292 237.2L227.5 150.6L412.4 150.6L348 237.2L412.5 421.2z"/></svg>
                        </div>
